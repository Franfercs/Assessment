...
const MoviePage: React.FC = () => {
    ...
    return (
        <div className="bg-[#0b1120] min-h-screen text-white flex flex-col">
            ...
            <div className="flex flex-col md:flex-row px-16 py-8 ">
                <img src={movie.Poster !== 'N/A' ? movie.Poster : Test} alt={movie.Title} className="w-full md:w-1/3 md:h-1/4 rounded-lg shadow-md" />
